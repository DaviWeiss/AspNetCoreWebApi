        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1, 1, "Lauro", "Oliveira", "33225486", DateTime.Parse("05/28/1990")),
                    new Professor(2, 2, "Roberto", "Soares", "22565896", DateTime.Parse("03/25/1970")),
                    new Professor(3, 3, "Ronaldo", "Marconi", "21865163", DateTime.Parse("01/08/1974")),
                    new Professor(4, 4, "Rodrigo", "Carvalho","89525632", DateTime.Parse("09/03/1991")),
                    new Professor(5, 5, "Alexandre", "Montanha", "42468796", DateTime.Parse("11/15/1985")),
                });
